...
- 34f855a: Bind the webhook `event` variable for every provider, not just GitHub. `match:`
  ...
  - @zooid/context-mcp@0.14.1
  - @zooid/runtime-docker@0.14.1
  - @zooid/runtime-local@0.14.1
  - @zooid/transport-http@0.14.1
  - @zooid/transport-matrix@0.14.1
