import { ZooidClient, type CreateChannelResult, type PublisherResult } from '@zooid/sdk';
...
export async function runChannelList(client?: ZooidClient): Promise<ChannelListItem[]> {
  const c = client ?? createClient();
